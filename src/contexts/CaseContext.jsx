...
export function CaseProvider({ children }) {
  ...
  const updateCase = useCallback(async (workspaceId, caseId, updates = {}) => {
    ...
    try {
      ...
      const updatedCase = await storage.getCase(workspaceId, caseId);
      if (rulesOrchestrator && updatedCase) {
        await rulesOrchestrator.evaluateAndPersistCase(workspaceId, updatedCase);
      }
  ...
  }, [state.cases, state.currentCase, rulesOrchestrator]);
